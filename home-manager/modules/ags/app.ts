...
function main() {
	...
	reloadScss('Public/ags/agsv2-nix-dotfiles/home-manager/modules/ags/style/osd.scss', '/tmp/astal/style.css', 'Public/ags/agsv2-nix-dotfiles/home-manager/modules/ags/style/main.scss');
	monitorDashboard();
}
